...
import CssSVG from "../assets/svg/css.component";
import DjangoSVG from "../assets/svg/django.component";
import FigmaSVG from "../assets/svg/figma.component";
import GitSVG from "../assets/svg/git.component";
import GraphqlSVG from "../assets/svg/graphql.component";
import HtmlSVG from "../assets/svg/html.component";
import JavaSVG from "../assets/svg/java.component";
import LinuxSVG from "../assets/svg/linux.component";
import NestSVG from "../assets/svg/nest.component";
import NodeSVG from "../assets/svg/node.component";
import PostmanSVG from "../assets/svg/postman.component";
import PythonSVG from "../assets/svg/python.component";
import ReactSVG from "../assets/svg/react.component";
import SpringBootSVG from "../assets/svg/spring-boot.component";
import TailwindSVG from "../assets/svg/tailwind.component";
import TypescriptSVG from "../assets/svg/typescript.component";
import VscodeSVG from "../assets/svg/vscode.component";
      ...
      <div className="flex flex-1 flex-col items-center">
        <div className="flex flex-col w-full max-w-[55rem] p-[2rem] space-y-10">
          ...
          <SkillCategory
            ...
            className="animate-[lightSpeedInLeft_1s_ease] fill-mode-backward"
            heading={
