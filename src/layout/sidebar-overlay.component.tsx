...
export default function SidebarOverlay() {
  ...
  return (
    <>
      <div
        className={cn(
          "flex fixed h-screen w-screen bg-edge-100 opacity-50 z-50 duration-500",
      ...
      >
        ...
        <div className="flex flex-col m-0">
          ...
          <Button
            variant={
              currentView.view === Views.PROJECTS ? "primary" : "edge-100"
            }
          ...
          >
            <ButtonContent>
              ...
              <ButtonText>
                {currentView.view === Views.PROJECTS ? <>&gt;</> : null}{" "}
                Projects
              </ButtonText>
              <ButtonSlider></ButtonSlider>
            </ButtonContent>
          ...
          <Button
            variant={
              currentView.view === Views.STUDIES ? "primary" : "edge-100"
            }
          ...
          <Button
            variant={
              currentView.view === Views.CONTACT ? "primary" : "edge-100"
            }
